...
// Date/Time Created : Jan. 25, 2016, 11:12 p.m.-->
// Site Name         : 3G_Tra-Kha_BLU                           //
// Site ID           : ERI_3G_BL5482                               //
// RBS ID            : 5482                                  //
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b5482"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b5482,IubDataStreams=1"
  exception none
