...
// Date/Time Created : Oct. 26, 2015, 11:02 p.m.-->
// Site Name         : 3G_Nga-4-Duong-Nui_AGG                           //
// Site ID           : AG4209                               //
// RBS ID            : 4209                                  //
//================================================================//
// Running at Node       : RBS                                    //
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4209"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4209,IubDataStreams=1"
  exception none
