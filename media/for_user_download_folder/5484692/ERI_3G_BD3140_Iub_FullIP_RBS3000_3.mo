...
// Date/Time Created : March 1, 2016, 5:56 p.m.-->
// Site Name         : 3G_KHC-Moi-Dau-Tieng_BDG                           //
// Site ID           : ERI_3G_BD3140                               //
// RBS ID            :                                   //
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b,IubDataStreams=1"
  exception none
