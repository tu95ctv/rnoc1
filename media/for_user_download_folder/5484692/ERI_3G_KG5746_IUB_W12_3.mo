...
//Date/Time Created : Feb. 29, 2016, 2:10 p.m.  //
// Site              :ERI_3G_KG5746(3G_TVT-Bai-Vong_KGG)           //
// RBS Id            :  5746                               // 
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b5746"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
exception none
nrOfParameters 5
        String  "10.213.227.180"  // ntpServerIpAddressPrimary
...
exception none
nrOfParameters 5
        String  "10.213.227.181 // ntpServerIpAddressSecondary
