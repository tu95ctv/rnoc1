...
// Date/Time Created : Oct. 26, 2015, 11:14 p.m.-->
// Site Name         : 3G_STR032A_STG                           //
// Site ID           : ST4563                               //
// RBS ID            : 4563                                  //
//================================================================//
// Running at Node       : RBS                                    //
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4563"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4563,IubDataStreams=1"
  exception none
