...
// Date/Time Created : Oct. 14, 2015, 5:22 p.m.-->
// Site Name         : 3G_AGG-Addl-015_AGG                           //
// Site ID           : AG4301                               //
// RBS ID            : 4301                                  //
//================================================================//
// Running at Node       : RBS                                    //
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4301"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4301,IubDataStreams=1"
  exception none
