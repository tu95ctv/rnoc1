...
// Date/Time Created : Oct. 14, 2015, 5:18 p.m.-->
// Site Name         : 3G_BRI020A_VTU                           //
// Site ID           : VT2666                               //
// RBS ID            : 2666                                  //
//================================================================//
// Running at Node       : RBS                                    //
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b2666"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b2666,IubDataStreams=1"
  exception none
