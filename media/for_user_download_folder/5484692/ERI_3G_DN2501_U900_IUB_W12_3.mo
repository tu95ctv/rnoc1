...
//Date/Time Created : Jan. 20, 2016, 2:42 p.m.  //
// Site              :ERI_3G_DN2501_U900(3G_Phu-Ngoc2_DNI)           //
// RBS Id            :  U900                               // 
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=bU900"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
exception none
nrOfParameters 5
        String  "234234234"  // ntpServerIpAddressPrimary
...
exception none
nrOfParameters 5
        String  "3423432434 // ntpServerIpAddressSecondary
