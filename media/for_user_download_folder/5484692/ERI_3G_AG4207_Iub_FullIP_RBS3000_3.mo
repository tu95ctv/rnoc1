...
// Date/Time Created : Dec. 6, 2015, 9:22 a.m.-->
// Site Name         : 3G_Phuong-Binh-Duc_AGG                           //
// Site ID           : ERI_3G_AG4207                               //
// RBS ID            : 4207                                  //
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4207"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4207,IubDataStreams=1"
  exception none
