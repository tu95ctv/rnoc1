...
// Date/Time Created : Oct. 26, 2015, 11:17 p.m.-->
// Site Name         : 3G_AGG-Addl-017_AGG                           //
// Site ID           : AG4231                               //
// RBS ID            : 4231                                  //
//================================================================//
// Running at Node       : RBS                                    //
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4231"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4231,IubDataStreams=1"
  exception none
