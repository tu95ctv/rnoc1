...
// Date/Time Created : Jan. 29, 2016, 1:23 p.m.-->
// Site Name         : 3G_AGG-Addl-009_AGG                           //
// Site ID           : ERI_3G_AG4253                               //
// RBS ID            : 4253                                  //
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b4253"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
SET
  (
  mo "ManagedElement=1,NodeBFunction=1,Iub=b4253,IubDataStreams=1"
  exception none
