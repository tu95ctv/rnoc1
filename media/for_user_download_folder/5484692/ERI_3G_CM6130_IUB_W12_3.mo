...
//Date/Time Created : Feb. 29, 2016, 5:30 p.m.  //
// Site              :ERI_3G_CM6130(3G_Quach-Pham-Bac_CMU)           //
// RBS Id            :  6130                               // 
//================================================================//
// Running at Node       : RBS                                    //
//================================================================//
...
CREATE
(
    parent "ManagedElement=1,NodeBFunction=1,Iub=b6130"
    identity "1"
    moType NbapCommon
    exception none
    nrOfAttributes 4
...
exception none
nrOfParameters 5
        String  "0.0.0.0 // ntpServerIpAddressSecondary
